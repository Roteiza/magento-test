...
return [
    'modules' => [
        ...
        'MercadoPago_Core' => 1,
        'Movistar_AbandonedCart' => 1,
        'Movistar_AdbPayment' => 1,
        'Movistar_AdminExports' => 1,
        'Movistar_AdminImports' => 1,
        'Movistar_AdminOrderItems' => 1,
        'Movistar_AdminOrdersGrid' => 1,
        'Movistar_AdminTvChannels' => 1,
        'Movistar_AlarmExport' => 1,
        'Movistar_Andreani' => 1,
        'Movistar_BannerSlider' => 1,
        'Movistar_BusinessToBusiness' => 1,
        'Movistar_CascadePricesUpdater' => 1,
        'Movistar_ChangeOffer' => 1,
        'Movistar_ChangeOrderStatus' => 1,
        'Movistar_ChargeCodes' => 1,
        'Movistar_ChargeOnBill' => 1,
        'Movistar_CheckoutCustomization' => 1,
        'Movistar_CheckoutTwoSteps' => 1,
        'Movistar_ColorSwatches' => 1,
        'Movistar_ConsultInvoice' => 1,
        'Movistar_Creditmemo' => 1,
        'Movistar_CustomAttributes' => 1,
        'Movistar_CustomFeeds' => 1,
        'Movistar_CustomImageRole' => 1,
        'Movistar_CustomOrderInvoice' => 1,
        'Movistar_CustomOrderStatusPage' => 1,
        'Movistar_CustomOrderStatuses' => 1,
        'Movistar_CustomOrderView' => 1,
        'Movistar_CustomPageSize' => 1,
        'Movistar_CustomerCustomAttributes' => 1,
        'Movistar_CustomerManagementFlow' => 1,
        'Movistar_DCP' => 0,
        'Movistar_DataLayers' => 1,
        'Movistar_EmailLogging' => 1,
        'Movistar_EmailVariables' => 1,
        'Movistar_Financing' => 1,
        'Movistar_FormValidation' => 1,
        'Movistar_FreeShipping' => 1,
        'Movistar_FrontendExtends' => 1,
        'Movistar_GammaGrid' => 1,
        'Movistar_GlobalCucarda' => 1,
        'Movistar_GraphQL' => 1,
        'Movistar_HideCustomersMenu' => 1,
        'Movistar_HighLine' => 1,
        'Movistar_HistoricalOrders' => 1,
        'Movistar_Hogarb2c' => 1,
        'Movistar_ImportPrices' => 1,
        'Movistar_InConcert' => 1,
        'Amasty_Checkout' => 1,
        'Movistar_InventorySales' => 1,
        'Movistar_Logging' => 1,
        'Movistar_MercadoPago' => 1,
        'Movistar_MessageCatalog' => 1,
        'Movistar_MovistarTV' => 1,
        'Movistar_OrderMissingInfo' => 1,
        'Movistar_PhoenixAutomation' => 1,
        'Movistar_PhoenixFlow' => 1,
        'Movistar_Installers' => 1,
        'Movistar_Portability' => 1,
        'Movistar_Preloader' => 1,
        'Movistar_PriceCurrency' => 1,
        'Movistar_ProductImportCsv' => 1,
        'Movistar_ProductLabels' => 1,
        'Movistar_Refunds' => 1,
        'Movistar_Sales' => 1,
        'Movistar_Security' => 1,
        'Movistar_Settings' => 1,
        'Movistar_Simcard' => 1,
        'Movistar_T3Codes' => 1,
        'Movistar_SingleItem' => 1,
        'Movistar_SortBy' => 1,
        'Movistar_SpecialInstallments' => 1,
        'Movistar_SpecialOffer' => 1,
        'Movistar_StaticBrandBlock' => 1,
        'Movistar_StockActions' => 1,
        'Movistar_StockSap' => 1,
        'Movistar_Swatches' => 1,
        'Movistar_SimcardExportImportRobot' => 1,
        'Movistar_Terminals' => 1,
        'Movistar_UpdateCustomDiscountPercent' => 1,
        'Movistar_UsersAdminImport' => 1,
        'Movistar_Utils' => 1,
        'Movistar_WebServices' => 1,
        'Movistar_Websites' => 1,
        'Nordcomputer_Showoutofstockprice' => 0,
        'Movistar_PortabilityExportImportRobot' => 1,
